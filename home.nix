...
in {
  ...
  programs = {
    ...
    git = {
      ...
      userEmail = "gh@reformstudios.com"; # FIXME: set your git email
      userName = "Patrick Macdonald"; #FIXME: set your git username
      extraConfig = {
    ...
    fish = {
      ...
      fish_add_path --append /mnt/c/Users/pm/scoop/apps/win32yank/0.1.1
